...
# 1 Template № 21895
c = 0 # counter *
for line in open('task_files/9_template-1.txt'): # import file *('**')
...
c = 0 # counter *
for line in open('task_files/9_template-2.txt'): # import file *('**')
    a = [int(x) for x in line.split()] # split int to lines *
...
# 3 Template № 21704
for line in open('task_files/9_template-3.txt'): # import file *('**')
    a = [int(x) for x in line.split()]  # split int to lines *
    ass = sorted(a) #sort ints (12, 43, 145)
