...
def f(a, b, m):
    ...
    return any(h) if m % 2 != 0 else any(h)# * all(h) or any(h)

print('19)', [s for s in range(1, 74) if f(7, s, 2)])# 19
print('20)', [s for s in range(1, 74) if not f(7, s, 1) and f(7, s, 3)])# 33 36
print('20)', [s for s in range(1, 74) if not f(7, s, 2) and f(7, s, 4)])# 32
